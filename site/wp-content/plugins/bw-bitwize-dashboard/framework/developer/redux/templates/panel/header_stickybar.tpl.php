		...
		<div class="redux-action_bar <?php echo ( false === $this->parent->args['hide_reset'] ) ? 'dev-mode' : '' ?>">
			...
			<div class="options-header-buttons-section">
				<div class="dfd-options-button-cover options-button-green">
					<?php submit_button( esc_html__( 'Save Changes', 'redux-framework' ), 'primary', 'redux_save', false, array('id' => 'redux_save_top') ); ?>
				</div>
				<?php if(defined('DFD_DEBUG_MODE') && DFD_DEBUG_MODE) : ?>
					<div class="dfd-options-button-cover options-button-green-border">
						<?php submit_button( esc_html__( 'Recompile All Styles', 'redux-framework' ), 'secondary', 'recompileStyleButton', false ,array("onclick"=>"return false;")); ?>
					</div>
					...
					<?php /* ?>
						<div class="dfd-options-button-cover">
							<?php submit_button( esc_html__( 'Reset Section', 'redux-framework' ), 'secondary dfd-reset-button', $this->parent->args['opt_name'] . '[defaults-section]', false ); ?>
						</div>
					<?php */ ?>
						<div class="dfd-options-button-cover">
							<?php submit_button( esc_html__( 'Reset options', 'redux-framework' ), 'secondary dfd-reset-button', $this->parent->args['opt_name'] . '[defaults]', false ); ?>
						</div>
					<?php endif; ?>
				<?php endif; ?>
			</div>
