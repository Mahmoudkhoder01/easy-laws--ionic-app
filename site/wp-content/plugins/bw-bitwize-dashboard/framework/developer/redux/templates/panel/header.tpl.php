		...
		<div class="display_header">
			...
			<h2>
				...
				<?php if ( ! empty( $this->parent->args['display_version'] ) ) { ?>
					<span><?php esc_html_e('Ver', 'redux-framework') ?>. <?php echo $this->parent->args['display_version']; ?></span>
				<?php } ?>
			</h2>

			<p class="clearfix">
				<?php esc_html_e('Any questions you can ask on our','redux-framework') ?> <a href="http://nativewptheme.net/support/" title="<?php esc_attr_e('Support forum', 'redux-framework') ?>" target="_blank"><?php esc_html_e('Support Forum','redux-framework') ?></a>
				<a class="docs-icon" href="http://nativewptheme.net/support/native-documentation" title="<?php esc_attr_e('Theme documentation','redux-framework') ?>" target="_blank"><?php esc_html_e('Native theme documentation','redux-framework') ?> <i class="dashicons dashicons-admin-comments"></i></a>
			</p>
