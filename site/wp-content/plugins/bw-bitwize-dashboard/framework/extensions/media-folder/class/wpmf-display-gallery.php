...
class Wpmf_Display_Gallery {
    ...
    function wpmf_gallery_print_media_templates() {
        $display_types = array(
            'default' => __('Default',BW_TD),
            'masonry' => __('Masonry', BW_TD),
            'portfolio' => __('Portfolio', BW_TD),
            'slider' => __('Slider', BW_TD),
        );
        ?>

        <script type="text/html" id="tmpl-wpmf-gallery-settings">
            <label class="setting">
                <span><?php _e('Gallery themes', BW_TD); ?></span>
            </label>
            ...
            <label class="setting">
                <span><?php _e('Columns', BW_TD); ?></span>
            </label>
            ...
            <label class="setting size">
               <span><?php _e( 'Gallery image size', BW_TD ); ?></span>
            </label>
            ...
            <label class="setting">
                <span><?php _e( 'Lightbox size', BW_TD ); ?></span>
            </label>
            ...
            <label class="setting">
                <span><?php _e('Action on click', BW_TD); ?></span>
            </label>

            <label class="setting">
                <select class="link-to" name="link" data-setting="link">
                    <option value="file" selected><?php echo _e('Lightbox',BW_TD); ?></option>
                    <option value="post"  ><?php echo _e('Attachment Page',BW_TD); ?></option>
                    <option value="none" ><?php echo _e('None',BW_TD); ?></option>
                </select>
            </label>

            <label class="setting">
                <span><?php _e('Auto insert image in folder', BW_TD); ?></span>
            </label>

            <label class="setting">
                <select class="autoinsert" name="autoinsert" data-setting="autoinsert">
                    <option value="0" selected><?php echo _e('No',BW_TD); ?></option>
                    <option value="1"  ><?php echo _e('Yes',BW_TD); ?></option>
                </select>
            </label>
    ...
    function wpmf_gallery_attachment_fields_to_edit($form_fields, $post) {
        ...
        $form_fields['gallery_link_target'] = array(
                'label' => __( 'Link target',BW_TD ) ,
                'input'	=> 'html',
                'html'	=> '
                        <select name="attachments['.$post->ID.'][gallery_link_target]" id="attachments['.$post->ID.'][gallery_link_target]">
                                <option value="">'.__( 'Same Window', BW_TD ).'</option>
                                <option value="_blank"'.($target_value == '_blank' ? ' selected="selected"' : '').'>'.__( 'New Window', BW_TD ).'</option>
                        </select>'
        );
