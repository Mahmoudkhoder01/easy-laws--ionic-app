...
jQuery(document).ready(function () {
    "use strict";
    app_shortcodes_start();
});

function app_shortcodes_start(){
    app_counter();
    app_progress_bar();
    app_progress_bar_vertical();
    app_circle_loader();
    app_circle_loader_icon();
}

function app_counter() {
    "use strict";
    if (jQuery('.app-counter.app-zero').length) {
        jQuery('.app-counter.app-zero').each(function () {
...
function app_progress_bar() {
    "use strict";
    if (jQuery('.app-progress-section').length) {
        jQuery('.app-progress-section').each(function () {
            jQuery(this).appear(function () {
                app_progress_bar_counter(jQuery(this));
...
function app_progress_bar_counter($this) {
    "use strict";
    var number = parseFloat($this.find('.progress-bar').data('number'));
    if ($this.find('.app-progress-number span').length) {
        $this.find('.app-progress-number span').each(function () {
...
function app_progress_bar_vertical() {
    "use strict";
    if (jQuery('.app-progress-section-vertical').length) {
        jQuery('.app-progress-section-vertical').each(function () {
            jQuery(this).appear(function () {
                app_progress_bar_vertical_counter(jQuery(this));
...
function app_progress_bar_vertical_counter($this) {
    "use strict";
    if ($this.find('.app-progress-number span').length) {
        $this.find('.app-progress-number span').each(function () {
            var $max = parseFloat(jQuery(this).text());
...
function app_circle_loader() {
    "use strict";
    if (jQuery('.app-circle-number').length) {
        jQuery('.app-circle-number').each(function () {
            ...
            jQuery(this).appear(function () {
                app_circle_loader_counter(jQuery(this));
                jQuery(this).parent().css('opacity', '1');
...
function app_circle_loader_icon() {
    "use strict";
    if (jQuery('.app-circle-icon').length) {
        jQuery('.app-circle-icon').each(function () {
            //variables for easyPieChart
            var $trackColor = jQuery(this).data('trackcolor');
            var $barColor   = jQuery(this).data('barcolor');
            var $lineWidth  = jQuery(this).data('linewidth');
...
function app_circle_loader_counter($this) {
    "use strict";
    jQuery($this).css('opacity', '1');
    var $max = parseFloat(jQuery($this).find('.app-circle-number').text());
    jQuery($this).find('.app-circle-number').countTo({
        from: 0,
        to: $max,
        speed: 1500,
        refreshInterval: 50
