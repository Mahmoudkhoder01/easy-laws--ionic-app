...
class App_Paginator
{
    ...
    public function toHtml(){
        ...
        if ($this->getPrevUrl()) {
            $html .= '<li><a href="' . $this->getPrevUrl() . '" class="previous-page">&laquo; '. $this->previousText .'</a></li>';
        }
        ...
        if ($this->getNextUrl()) {
            $html .= '<li><a href="' . $this->getNextUrl() . '" class="next-page">'. $this->nextText .' &raquo;</a></li>';
        }
        $html .= '</ul>';
        return $html;
    }
