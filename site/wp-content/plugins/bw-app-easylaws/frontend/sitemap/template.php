    ...
    <xsl:template match="/">
        <html xmlns="http://www.w3.org/1999/xhtml">
            <head>
                ...
                <style type="text/css">
                    body{font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#545353}table{border:none;border-collapse:collapse}
                    ...
                    #content{margin:0 auto;width:1000px}.expl{margin:18px 3px;line-height:1.2em}
                    .expl a{color:#da3114;font-weight:bold} 
                    .expl a:visited{color:#da3114}
                    a{color:#000;text-decoration:none}
                    a:visited{color:#777}
                    a:hover{text-decoration:underline}
                    td{font-size:11px; padding: 10px 5px; border-bottom: 1px solid #eee;}
            ...
            <body>
                <div id="content">
                    <h1>XML Sitemap</h1>
                    <p class="expl">Generated by <a href="https://bitwize.com.lb/">Bitwize</a>, this is an XML Sitemap, meant for consumption by search engines.<br/>You can find more information about XML sitemaps on <a href="http://sitemaps.org">sitemaps.org</a>.</p>
                    ...
                    <xsl:if test="count(sitemap:sitemapindex/sitemap:sitemap) &gt; 0">
                        ...
                        <table id="sitemap" cellpadding="3">
                            <thead><tr>
                                <th width="75%">Sitemap</th><th width="25%">Last Modified</th>
                            </tr></thead><tbody>
                    ...
                    <xsl:if test="count(sitemap:sitemapindex/sitemap:sitemap) &lt; 1">
                        ...
                        <p class="expl"><a href="<?php echo site_url('sitemap.xml');?>">&#8593; Sitemap Index</a></p>
                        <table id="sitemap" cellpadding="3"><thead>
                            <tr><th width="75%">URL</th><th title="Index Priority" width="5%">Prio</th><th width="5%">Images</th><th title="Change Frequency" width="5%">Ch. Freq.</th><th title="Last Modification Time" width="10%">Last Mod.</th></tr>
                        </thead><tbody>
