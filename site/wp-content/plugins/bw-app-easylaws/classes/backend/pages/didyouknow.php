...
class App_Didyouknow {

	public function __construct() {
		$this->singular = 'Did you know';
		$this->plural = 'Did you know';
		$this->slug = 'app-did-you-know';
	...
	public function display(){
		require_once( dirname(__FILE__) . '/didyouknow-list.php' );
		$list_table = new App_Didyouknow_List_Table;
		$per_page = 20;
