...
class App_Keywords {
	...
	public function __construct() {
		$this->singular = 'Keyword';
		$this->plural = 'Keywords';
		$this->slug = 'app-keywords';
		$this->table_name  = DB()->prefix.'app_keywords';
		...
		add_action('app_admin_menu', array($this, 'menu'), 15);
	}
	...
	public function display(){
		require_once( dirname(__FILE__) . '/keywords-list.php' );
		$list_table = new App_Keywords_List_Table;
		$per_page = 20;
