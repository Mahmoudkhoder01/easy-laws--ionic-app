...
class App_Admin_Devices {

	public function __construct() {
		$this->singular = 'Device';
		$this->plural = 'Devices';
		$this->slug = 'app-devices';
	...
	public function display(){
		require_once( dirname(__FILE__) . '/devices-list.php' );
		$list_table = new App_Devices_List_Table;
		$per_page = 20;
