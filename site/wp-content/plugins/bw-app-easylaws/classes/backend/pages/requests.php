...
class App_Requests {
	...
	public function __construct() {
		...
		$this->slug = 'app-requests';
		$this->table_name  = DB()->prefix.'app_requests';
	...
	public function menu(){
		$p = add_menu_page($this->plural, $this->plural, 'edit_pages', $this->slug, array($this, 'display'), '', '2.0202');
		add_action('load-'.$p, array($this, 'per_page'));
	}

	public function display(){
		require_once( dirname(__FILE__) . '/requests-list.php' );
		$list_table = new App_Requests_List_Table;
		$per_page = 20;
