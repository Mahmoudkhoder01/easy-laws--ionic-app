...
class App_Definitions_List_Table extends WP_List_Table {
	public $base_link;

    public function prepare_items($per_page = 20, $base_link = '') {
    	$this->base_link = $base_link;
        $table = DB()->prefix . 'app_definitions';
    ...
    public function single_row($row) {
        ...
        foreach ($columns as $column_name => $column_display_name) {
            ...
            switch ($column_name) {
                ...
                case 'examples': $r.= "<td $atts>".app_repeat_count($row->examples)."</td>"; break;
                case 'notes': $r.= "<td $atts>".app_repeat_count($row->notes)."</td>"; break;
                // case 'keywords': $r.= "<td $atts>$row->keywords</td>"; break;
